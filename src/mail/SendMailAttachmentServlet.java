...
@WebServlet(name = "SendMailAttachmentServlet", urlPatterns = {"/sendattachment"})
public class SendMailAttachmentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String to = "srikanth@st.com";
        String from = "student@st.com";
        String subject = "Ship";
        String body = "<h2>Ship.....</h2>";
        ...
        Authenticator auth = new Authenticator(){
            ...
            public PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("student@st.com","s");
            }
        };
